...
VPS_JSON_URL="https://raw.githubusercontent.com/cmf866/my-IP/main/format.yueb886.json?token=GHSAT0AAAAAACXF5CZ7N7MGEMUJT4WG4QJMZXKGUMA"  # 储存vps登录信息及无交互脚本外部变量的json文件
